 ...
 * api/fixtures/GelType.java (Theatrical Team, Apache License 2.0).
 *
 * CHANGED FROM UPSTREAM: none beyond the port (the Roscolux table is data, no Minecraft
 * API involved). Upstream's own licence header follows.
 */
/*
