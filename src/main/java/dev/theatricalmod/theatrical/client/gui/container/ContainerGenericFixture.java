 ...
 * client/gui/container/ContainerGenericFixture.java (Theatrical Team, Apache License 2.0); the upstream file
...
/** Generic fixture screen: pan and tilt. */
public class ContainerGenericFixture extends Container {
    ...
    public ContainerGenericFixture(World world, BlockPos pos) {
        this.world = world;
        this.pos = pos;
    ...
    @Nullable
    private static TileEntityGenericFixture asTile(World world, BlockPos pos) {
        net.minecraft.tileentity.TileEntity tile = world.getTileEntity(pos);
        return tile instanceof TileEntityGenericFixture ? (TileEntityGenericFixture) tile : null;
    }
