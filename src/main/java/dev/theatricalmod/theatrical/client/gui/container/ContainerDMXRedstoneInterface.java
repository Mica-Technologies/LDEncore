 ...
 * client/gui/container/ContainerDMXRedstoneInterface.java (Theatrical Team, Apache License 2.0); the upstream file
...
/** DMX-redstone interface screen: the DMX start address. */
public class ContainerDMXRedstoneInterface extends Container {
    ...
    public ContainerDMXRedstoneInterface(World world, BlockPos pos) {
        this.world = world;
        this.pos = pos;
    ...
    @Nullable
    private static TileEntityDMXRedstoneInterface asTile(World world, BlockPos pos) {
        net.minecraft.tileentity.TileEntity tile = world.getTileEntity(pos);
        return tile instanceof TileEntityDMXRedstoneInterface ? (TileEntityDMXRedstoneInterface) tile : null;
    }
