 ...
 * client/gui/container/ContainerBasicLightingConsole.java (Theatrical Team, Apache License 2.0); the upstream file
...
/** Lighting desk screen: faders, cues and fade times. */
public class ContainerBasicLightingConsole extends Container {
    ...
    public ContainerBasicLightingConsole(World world, BlockPos pos) {
        this.world = world;
        this.pos = pos;
    ...
    @Nullable
    private static TileEntityBasicLightingControl asTile(World world, BlockPos pos) {
        net.minecraft.tileentity.TileEntity tile = world.getTileEntity(pos);
        return tile instanceof TileEntityBasicLightingControl ? (TileEntityBasicLightingControl) tile : null;
    }
